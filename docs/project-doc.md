...
- San Jose's SHAP Decision Plot
	...
	<img src="/src_sample/interactiveWebpage/assets/shap_plots/sj_shap.png" width = "50%">

- San Francisco's SHAP Decision Plot

	<!-- ![](/src_sample/interactiveWebpage/assets/shap_plots/sf_shap.png){: width="50%"} -->
	<img src="/src_sample/interactiveWebpage/assets/shap_plots/sf_shap.png" width = "75%">
...
- San Jose's PDP's
	...
	|:---------------------------------------------------------------------: | :---------------------------------------------------------------------:|
	| ![alt text](/src_sample/interactiveWebpage/assets/pdp_plots/sj_pdp_season.png) | ![alt text](/src_sample/interactiveWebpage/assets/pdp_plots/sf_pdp_tmax.png) | ![alt text](/src_sample/interactiveWebpage/assets/pdp_plots/sf_pdp_tmin.png) |
  
- San Francisco PDP's
	| Max Temperature PDP | Min Temperature PDP |
	|:---------------------------------------------------------------------: | :---------------------------------------------------------------------:|
	| ![alt text](/src_sample/interactiveWebpage/assets/pdp_plots/sf_pdp_tmax.png) | ![alt text](/src_sample/interactiveWebpage/assets/pdp_plots/sf_pdp_tmin.png) |
