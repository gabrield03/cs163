...
<!-- Ex. ![alt text](/docs/assets/plots/Dual_Ax_95110.png) -->
		- San Jose's SHAP
![alt text](/src_sample/interactiveWebpage/assets/shap_plots/sj_shap.png)

		- San Francisco's SHAP
![alt text](/src_sample/interactiveWebpage/assets/shap_plots/sf_shap.png)
...
<!-- Ex. ![alt text](/docs/assets/plots/Dual_Ax_95110.png) -->
		- San Jose's PDP's
![alt text](/src_sample/interactiveWebpage/assets/pdp_plots/sj_pdp_season.png | width = 50) ![alt text](/src_sample/interactiveWebpage/assets/pdp_plots/sf_pdp_tmax.png | width = 50) ![alt text](/src_sample/interactiveWebpage/assets/pdp_plots/sf_pdp_tmax.png | width = 50)


		- San Francisco PDP's
			![alt text](/src_sample/interactiveWebpage/assets/pdp_plots/sf_pdp_tmax.png | width = 50)

			![alt text](/src_sample/interactiveWebpage/assets/pdp_plots/sf_pdp_tmax.png | width = 50)

			![alt text](/src_sample/interactiveWebpage/assets/pdp_plots/sf_pdp_totalcustomers.png | width = 50)
